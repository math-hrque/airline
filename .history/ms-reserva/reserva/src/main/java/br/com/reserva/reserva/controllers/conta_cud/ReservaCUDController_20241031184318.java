...
public class ReservaCUDController {
    ...
    public ResponseEntity<Object> fazerCheckin(@PathVariable("codigoReserva") String codigoReserva) {
        try {
            Object reservaCheckin = reservaCUDService.fazerCheckin(codigoReserva);
